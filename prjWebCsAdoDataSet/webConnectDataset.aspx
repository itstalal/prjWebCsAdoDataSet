<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webConnectDataset.aspx.cs" Inherits="prjWebCsAdoDataSet.webConnectDataset" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1 style="text-align:center">
                GESTION DES EQUIPES <br /> Avec Sataset Connecte a une Base De Donnees
    ...
    <tr>
        ...
        <td rowspan="5">
            ...
            <asp:Button ID="btnSupprimer" OnClick="btnSupprimer_Click" runat="server"  Text="Supprimer" Font-Bold="True" ForeColor="White" BackColor="Brown" Width="150px" /><br />
